...
def fly_scaler_motor(
    ...
    ::
        ...
        RE(fly_scaler_motor(scaler, motor, start_position, end_position, velocity=None, num_points=10, md={}))

    New in release 1.6.6
    """
    flyer = ContinuousScalerMotorFlyer(
        # scaler, motor, start_position, end_position,
        # velocity=velocity, num_points=num_points,
