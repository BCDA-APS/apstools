...
def axis_component(parms: Union[None, str, Dict[str, Any]]) -> Component:
    ...
    axis_class_name = _parms.pop("class", None)
    factory = _parms.pop("factory", None)
...
def mb_class_factory(
    ...
    axes: Dict[str, Component] = {axis: axis_component(parms) for axis, parms in _motors.items()}
    ...
    return type(class_name, tuple(_class_bases), factory_class_attributes)
